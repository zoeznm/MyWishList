const hoverDiv1 = document.querySelector(".hover_div1");
const hoverDiv2 = document.querySelector(".hover_div2");
const hoverDiv3 = document.querySelector(".hover_div3");
const hoverDiv4 = document.querySelector(".hover_div4");
const hoverDiv5 = document.querySelector(".hover_div5");
const hoverDiv6 = document.querySelector(".hover_div6");
const hoverDiv7 = document.querySelector(".hover_div7");
const hoverDiv8 = document.querySelector(".hover_div8");
const hoverDiv9 = document.querySelector(".hover_div9");
